...
def test_fetch_btc5m_snapshot_returns_dict():
    books_resp = [
    ...
    with patch("market_data.fetch_post", return_value=books_resp), \
        ...
        snap = fetch_btc5m_snapshot("UP_TOKEN", "DN_TOKEN", window_end_epoch=1775078700)
...
def test_fetch_btc5m_snapshot_missing_book_returns_none_asks():
    books_resp = [
